...
surface = (0.0, 0.0, 0.0)
target = (2000.0, 0.0, 4820.0)
df, summary = generate_well_trajectory(surface, 1000.0, target, 1.5, step=1, trajectory_type='S-Type (Type III)', drop_rate=3.0, max_inclination=45.0)
print(summary)
